    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At wishlearners, we are dedicated to safeguarding your privacy and
            ...
            wishlearners. This Privacy Policy also outlines our data storage
          ...
          <p className="mb-4">
            At wishlearners, we will only request personal information when it
          ...
          <p className="mb-4">
            In the event that wishlearners invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while wishlearners may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which wishlearners may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any wishlearners distribution list,
          ...
          <p className="mb-4">
            ...
            wishlearners, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The wishlearners website may contain links to external websites,
            ...
            are not governed by wishlearners's privacy policy. wishlearners has
          ...
          <p className="mb-4">
            ...
            wishlearners's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features.
            wishlearners cannot be held responsible for the privacy policies
          ...
          <p className="mb-4">
            ...
            paramount at wishlearners. We have implemented robust measures to
          ...
          <p className="mb-4">
            At wishlearners, we remain committed to upholding the highest
          ...
          <p className="mb-4">
            ...
            wishlearners remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At wishlearners, we are committed to maintaining the highest
          ...
          <p className="mb-4">
            wishlearners is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, wishlearners is
          ...
          <p className="mb-4">
            wishlearners is subject to the investigative and enforcement
          ...
          <p className="mb-4">
            wishlearners reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of wishlearners’s website to stay informed of any
